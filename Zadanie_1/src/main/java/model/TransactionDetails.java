...
public class TransactionDetails {
    ...
    public String getVehicleFirstRegistrationDate() {
        return vehicleFirstRegistrationDate;
    }

    public void setVehicleFirstRegistrationDate(String vehicleFirstRegistrationDate) {
    ...
    public String getVehicleRegisterExpiryDate() {
        return vehicleRegisterExpiryDate;
    }

    public void setVehicleRegisterExpiryDate(String vehicleRegisterExpiryDate) {
        this.vehicleRegisterExpiryDate = vehicleRegisterExpiryDate;
    }

    public String getVehicleRegisterSetUpDate() {
        return vehicleRegisterSetUpDate;
    }

    public void setVehicleRegisterSetUpDate(String vehicleRegisterSetUpDate) {
    ...
    public String getVehicleNumberOfAxles() {
        return vehicleNumberOfAxles;
    }

    public void setVehicleNumberOfAxles(String vehicleNumberOfAxles) {
    ...
    public String getVehicleStandingPlaces() {
        return vehicleStandingPlaces;
    }

    public void setVehicleStandingPlaces(String vehicleStandingPlaces) {
